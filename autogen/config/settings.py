...
class APIConfig:
    """Konfiguracja API"""
    # LLM provider LLM
    llm-provider_api_key: str = ""
    llm-provider_model: str = "llm-3-5-sonnet-20241022"
    llm-provider_max_tokens: int = 4000
    llm-provider_temperature: float = 0.7
...
class EdenConfig:
    ...
    def load_environment_variables(self):
        ...
        self.api.llm-provider_api_key = os.getenv("LLM_PROVIDER_API_KEY", self.api.llm-provider_api_key)
    ...
    def validate_config(self) -> bool:
        ...
        # Sprawdź API keys
        if not self.api.llm-provider_api_key:
            errors.append("Brak LLM provider API Key")
